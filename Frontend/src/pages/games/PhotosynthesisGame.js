        ...
        <div className="border-b bg-background/80 backdrop-blur-sm sticky top-0 z-50">
          <div className="container mx-auto px-4 py-4 flex items-center justify-between">
            <div className="flex items-center gap-4">
              ...
              <h1 className="text-xl font-bold">Photosynthesis Explorer</h1>
            </div>
            <div className="flex items-center gap-4">
            ...
            <CardContent className="space-y-6">
              ...
              <div className="bg-green-50 p-6 rounded-lg border border-green-200">
                ...
                <ul className="space-y-2 text-green-700">
                  ...
                  <li className="flex items-start gap-2">
                    <span>📚</span>
                    <span>Learn the photosynthesis equation: 6H₂O + 6CO₂ + Light → C₆H₁₂O₆ + 6O₂</span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span>⭐</span>
            ...
            <CardContent className="space-y-6 text-center">
              <div className="bg-green-100 p-6 rounded-lg">
                ...
                <div className="grid grid-cols-2 gap-4">
                  ...
                  <div>
                    <div className="text-3xl font-bold text-green-600">{questionsCorrect}</div>
                    <div className="text-sm text-green-700">Plants Grown</div>
                  </div>
                  <div>
                    <div className="text-3xl font-bold text-green-600">{Math.round((questionsCorrect / totalQuestions) * 100)}%</div>
      ...
      <div className="border-b bg-background/80 backdrop-blur-sm sticky top-0 z-50">
        <div className="container mx-auto px-4 py-4 flex items-center justify-between">
          <div className="flex items-center gap-4">
            ...
            <h1 className="text-xl font-bold">🌱 Photosynthesis Game</h1>
          </div>
          <div className="flex items-center gap-4">
            <Badge variant="secondary">Level {level}</Badge>
            <Badge variant="secondary">Score: {score}</Badge>
            <Badge variant="secondary">{questionsCorrect}/{totalQuestions} Correct</Badge>
          </div>
        </div>
      </div>
